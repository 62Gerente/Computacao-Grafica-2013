...
#include "../../primitives/cylinder/cylinder.h"
    ...
    void drawWineCup_top(double r, double alt, int nlados, int ncamadas);


    void drawWineCup(double alt ,  int nlados, int ncamadas) {

        drawWineCup_top(alt/6, alt, nlados, ncamadas);

        
        glPushMatrix();
        glTranslatef(0, alt/2/2+alt/50, 0);
        glRotatef(90,1,0,0);
        ...
        drawCylinder(alt/80, alt/2/2, nlados, ncamadas/3);
        glPopMatrix();
